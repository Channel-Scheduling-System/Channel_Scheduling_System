...
export function appointmentCancelledHTML(
    ...
    return `
        ...
        <body>
            <div class="wrapper">
                ...
                <div class="content">
                    <p class="content__greeting">Hola ${data.cancelledToName},</p>
                    ...
                    <div class="details-wrap">
                        <div class="details-wrap__item"><strong>Fecha de la cita:</strong> ${data.date}</div>
                        <div class="details-wrap__item"><strong>Horario establecido:</strong> ${data.time}</div>
                        ${
                            data.reason
                                ? `
